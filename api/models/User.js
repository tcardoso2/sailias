...
without necessarily having a billing card.`
    ...
    deleted: {
      type: 'boolean',
      description: 'Whether the user was deleted or not',
      extendedDescription: "Deleted users are only 'soft' deleted. Meaning these will remain in the DB but will be considered as not valid" 
    }
