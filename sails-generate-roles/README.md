# @mac/sails-generate-roles

A `roles` generator for use with the Sails command-line interface.


## Installation

```sh
$ npm install @mac/sails-generate-roles --save
```
...
{
  "modules": {
    "roles": "@mac/sails-generate-roles"
  }
}
```

> Note that instead of `"@mac/sails-generate-roles"`, you can also choose to provide the path to the generator locally (e.g. "./generators/roles").
...
## Bugs &nbsp; [![NPM version](https://badge.fury.io/js/@mac/sails-generate-roles.svg)](http://npmjs.com/package/@mac/sails-generate-roles)
...
[![NPM](https://nodei.co/npm/@mac/sails-generate-roles.png?downloads=true)](http://npmjs.com/package/@mac/sails-generate-roles)



## License

This roles generator is available under the **MIT license**.
