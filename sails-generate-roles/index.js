...
/**
 * @tcardoso2/sails-generate-roles
 *
 * Usage:
 * `sails generate roles`
 *
 * @description Generates a roles.
...
module.exports = {
  ...
  before: function (scope, done) {
    ...
    // //
    // // e.g. if someone runs:
    // // $ sails generate roles user find create update
    // // then `scope.args` would be `['user', 'find', 'create', 'update']`
    if (_.isUndefined(scope.args[0])) {
      return done(new Error('Please provide names for the roles.'));
    }
  ...
  targets: {
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    //TODO:
    //api/controllers/roles.js
    //api/controllers/view-roles.js
    //views/pages/roles.ejs
  },
